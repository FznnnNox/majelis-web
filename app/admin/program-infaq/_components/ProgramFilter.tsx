...
export type StatusFilter = "Semua" | "Aktif" | "Nonaktif";
...
const STATUS_OPTIONS: StatusFilter[] = ["Semua", "Aktif", "Nonaktif"];
...
export default function ProgramFilter({
  ...
  return (
    <div className="bg-white/90 backdrop-blur-md rounded-2xl p-3 border border-gray-100/80 shadow-2xs flex flex-col sm:flex-row items-center justify-between gap-3">
      ...
      <div className="inline-flex items-center gap-1 bg-gray-50 border border-gray-200/80 rounded-xl p-1 w-full sm:w-auto">
