...
//             <span>Waktu Pelaksanaan: Ba&apos;da Maghrib - Isya</span>
//           </p>
//         </div>
...
//           <span>{day.petugas.length} Santri Bertugas</span>
//         </div>
//       </div>
...
//           <PetugasCard key={person.name} person={person} index={i} />
//         ))}
//       </motion.div>
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between pb-6 border-b border-slate-100">
        <div>
          <div className="flex items-center gap-2 flex-wrap">
            ...
            {day.tugas && (
              <span className="rounded-md bg-amber-50 px-2.5 py-0.5 text-[10px] font-bold text-amber-700 border border-amber-200/60 flex items-center gap-1">
                <Sparkles className="h-3 w-3 text-[#e76f3c]" />
                {day.tugas}
              </span>
            )}
          </div>
