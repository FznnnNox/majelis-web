...
//       <div>
//         <h3 className="text-xl font-bold text-gray-900">Niat Donasi Diterima!</h3>
...
//       {/* Box Rekening & QRIS */}
//       <div className="w-full max-w-md rounded-2xl bg-slate-50 p-5 border border-slate-200 text-left space-y-4">
//         {/* Info BSI */}
//         <div>
...
//             <span className="text-lg font-extrabold text-gray-900 tracking-wide">
//               {noRekening}
//             </span>
//             <button
//               onClick={handleCopy}
//               className="flex items-center gap-1 text-xs font-medium bg-emerald-50 text-emerald-700 hover:bg-emerald-100 px-3 py-1.5 rounded-lg transition"
//             >
//               {copied ? <Check className="h-3.5 w-3.5" /> : <Copy className="h-3.5 w-3.5" />}
//               {copied ? "Tersalin" : "Salin"}
//             </button>
//           </div>
//           <p className="text-xs text-gray-500 mt-0.5">a.n. Majelis Ta'lim Al-Inayah</p>
//         </div>
...
//         Setelah mentransfer, donasi akan diverifikasi oleh pengurus majelis dan progress akan diperbarui otomatis.
//       </p>

//       <button
//         onClick={onDonateAgain}
//         className="w-full py-3 rounded-xl bg-gray-900 hover:bg-gray-800 text-white font-semibold text-sm transition"
//       >
//         Kirim Donasi Lain
//       </button>
//     </div>
...
export default function SuccessState({ nominal, onDonateAgain }: Props) {
  ...
  return (
    <div className="flex flex-col items-center justify-center text-center py-6 space-y-6">
      {/* Arch-topped badge, echoing the mihrab silhouette */}
      ...
      <div className="w-full max-w-md rounded-2xl bg-[#f8faf9] p-5 border border-gray-200/80 text-left space-y-4">
        ...
        <div>
          ...
          <p className="text-xs text-gray-500 mt-1">a.n. Majelis Ta'lim Al-Inayah</p>
        </div>
