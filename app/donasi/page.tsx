...
import { FeaturedCampaign, DonorFormState } from "./types";
            ...
            <div className="lg:col-span-7 flex flex-col justify-between">
              {isSuccess ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-7">
                  ...
                  <DonorInfoForm formData={donorForm} onChange={setDonorForm} />
...
export default function DonasiPage() {
  return (
    <>
      ...
      <Suspense
        fallback={
          <div className="min-h-screen pt-[120px] text-center text-xs text-gray-400">
            Memuat halaman...
          </div>
        }
      >
